...
// DiamondTestInit contract reusable accross upgrades, and can be used for multiple diamonds.

contract DiamondTestInit {
    ...
    function init(
        ...
        LibRelayerManagerTest.init(_uniswapRouter);
    }
}
