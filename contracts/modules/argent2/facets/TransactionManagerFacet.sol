...
contract TransactionManagerFacet is BaseFacet {
    ...
    */
    ...
    function addToWhitelist(address _wallet, address _target) external onlyWalletOwnerOrSelf(_wallet) onlyWhenUnlocked(_wallet) onlyWhenSecurityEnabled(_wallet) {
        ...
        uint256 whitelistAfter = block.timestamp + LibTransactionManager.diamondStorage().whitelistPeriod;
    ...
    */
    ...
    function startSession(address _wallet, address _sessionUser, uint64 _duration) internal {
        ...
        LibBaseModule._setSession(_wallet, _sessionUser, expiry);
